...
def lambda_handler(event, context):
    ...
    result = upload_file_s3(bucket, f'yuha/{file_name}.csv', result)
...
def movie_url(moviecd):
    return f'http://www.kobis.or.kr/kobisopenapi/webservice/rest/movie/searchMovieInfo.json?key=dddea6429a20616861ab4a73b4618dc3&movieCd={moviecd}'
...
def news_crawler(df):
    ...
    df['startDt'] = df['openDt_c'] - timedelta(15)
    df['endDt'] = df['openDt_c'] + timedelta(15)
